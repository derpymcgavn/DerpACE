...
| Nomad Self-Found Trophies | Existing creature trophy/create-list drops from Nomad kills are stamped with hidden owner/source properties. Future Nomad dynamic quests can require trophies obtained by that exact Nomad, so traded copies do not count. |
