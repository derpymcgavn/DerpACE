...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class CasterWcids
    {
        ...
        {
            ( WeenieClassName.orb,                    0.040f ),
            ( WeenieClassName.sceptre,                0.040f ),
            ( WeenieClassName.staff,                  0.040f ),
            ( WeenieClassName.wand,                   0.040f ),
            ( WeenieClassName.wandslashing,           0.045f ),
            ( WeenieClassName.wandpiercing,           0.044f ),
            ( WeenieClassName.wandblunt,              0.044f ),
            ( WeenieClassName.wandacid,               0.044f ),
            ( WeenieClassName.wandfire,               0.044f ),
            ( WeenieClassName.wandfrost,              0.044f ),
            ( WeenieClassName.wandelectric,           0.044f ),
            ( WeenieClassName.ace43381_nethersceptre, 0.044f ),
            ( WeenieClassName.ace31819_slashingbaton, 0.044f ),
            ( WeenieClassName.ace31825_piercingbaton, 0.044f ),
            ( WeenieClassName.ace31821_bluntbaton,    0.044f ),
            ( WeenieClassName.ace31820_acidbaton,     0.044f ),
            ( WeenieClassName.ace31823_firebaton,     0.044f ),
            ( WeenieClassName.ace31824_frostbaton,    0.044f ),
            ( WeenieClassName.ace31822_electricbaton, 0.044f ),
            ( WeenieClassName.ace43382_netherbaton,   0.044f ),
            ...
            ( WeenieClassName.ace420420421_martyrstaff, 0.015f ),
        };

        private static ChanceTable<WeenieClassName> T8_Chances = new ChanceTable<WeenieClassName>()
        {
            ( WeenieClassName.orb,                    0.035f ),
            ( WeenieClassName.sceptre,                0.035f ),
            ( WeenieClassName.staff,                  0.035f ),
            ( WeenieClassName.wand,                   0.035f ),
            ( WeenieClassName.wandslashing,           0.035f ),
            ( WeenieClassName.wandpiercing,           0.034f ),
            ( WeenieClassName.wandblunt,              0.034f ),
            ( WeenieClassName.wandacid,               0.034f ),
            ( WeenieClassName.wandfire,               0.034f ),
            ( WeenieClassName.wandfrost,              0.034f ),
            ( WeenieClassName.wandelectric,           0.034f ),
            ( WeenieClassName.ace43381_nethersceptre, 0.034f ),
            ( WeenieClassName.ace31819_slashingbaton, 0.034f ),
            ( WeenieClassName.ace31825_piercingbaton, 0.034f ),
            ( WeenieClassName.ace31821_bluntbaton,    0.034f ),
            ( WeenieClassName.ace31820_acidbaton,     0.034f ),
            ( WeenieClassName.ace31823_firebaton,     0.034f ),
            ( WeenieClassName.ace31824_frostbaton,    0.034f ),
            ( WeenieClassName.ace31822_electricbaton, 0.034f ),
            ( WeenieClassName.ace43382_netherbaton,   0.034f ),
            ...
            ( WeenieClassName.ace420420421_martyrstaff, 0.035f ),
        };
