    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("wi_name_loot_bias", new Property<bool>(true, "DerpACE: applies a hidden, rotating character-name bias to generated loot quality")),
                ...
                ("npc_personas_enabled", new Property<bool>(true, "DerpACE: enables persistent bounded NPC personas and player relationship memories")),
                ("npc_persona_vendor_discounts", new Property<bool>(true, "DerpACE: allows affinity-based ordinary vendor discounts; never applies to trade notes or alternate currencies")),
                ...
                ("roadrunner_enabled", new Property<bool>(true, "DerpACE: grants the Roadrunner +600 Run enchantment while players stand on outdoor DAT road cells")),
                ...
                ("town_ambient_npcs_enabled", new Property<bool>(true, "DerpACE: enables restrained ambient gestures, memory, and tethered jogging for NPCs in known towns")),
                ("town_ambient_npc_speech_enabled", new Property<bool>(false, "DerpACE: if TRUE, ambient town NPCs may occasionally speak local flavor lines; default is silent gesture-only ambience")),
                ...
                ("unarmed_combat_upgrades", new Property<bool>(true, "if TRUE, players fighting truly unarmed (no weapon, no fist/foot armor) deal damage that scales with the Light Weapons skill up to tier 5 unarmed weapon damage. Steel-toed boots also grant bonus damage on high-power hits, scaling with the boots' armor level.")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("wi_name_loot_bias_max", new Property<double>(0.08, "DerpACE: maximum positive or negative loot quality adjustment from the hidden WI name bias")),
                ("wi_name_loot_bias_hours", new Property<double>(6.0, "DerpACE: hours before the rotating portion of the hidden WI name bias changes")),
                ...
                ("npc_persona_affinity_daily_cap", new Property<double>(3.0, "Maximum positive affinity a character can gain with one NPC WCID per UTC day")),
                ("npc_persona_discount_affinity_threshold", new Property<double>(20.0, "Affinity required before an ordinary vendor begins offering a relationship discount")),
                ("npc_persona_vendor_discount_max", new Property<double>(0.08, "Maximum ordinary-item purchase discount at 100 affinity; trade notes and alternate currencies are excluded")),
                ...
                ("roadrunner_check_interval", new Property<double>(0.20, "Seconds between checks for entering or leaving an outdoor road cell; minimum 0.10")),
                ...
                ("town_ambient_npc_interval_min", new Property<double>(150.0, "Minimum seconds between autonomous ambient actions by a town NPC")),
                ("town_ambient_npc_interval_max", new Property<double>(360.0, "Maximum seconds between autonomous ambient actions by a town NPC")),
                ("unarmed_min_base_damage", new Property<double>(2.0, "if unarmed_combat_upgrades is enabled, the minimum base damage of a truly-unarmed strike (at 0 Light Weapons skill).")),
                ("unarmed_max_base_damage", new Property<double>(34.0, "if unarmed_combat_upgrades is enabled, the maximum base damage of a truly-unarmed strike at unarmed_skill_for_max_damage Light Weapons skill (defaults to roughly tier 5 unarmed weapon damage).")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<string>> DefaultStringProperties =
            DictOf(
                ...
                ("pathfinding_mesh_root", new Property<string>("", "Optional override for the root folder containing prebuilt navmesh files. The folder must contain 'Indoors' and 'Outdoors' subdirectories. Empty = use the default <ACE.Server.dll>/Pathfinding/Meshes/ folder."))
                );
    }
}
