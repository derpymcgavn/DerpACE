    ...
    public static class HardcodedWeenies
    {
        ...
        public static void RegisterAll()
        {
            try
            {
                ...
                DatabaseManager.World.SetCachedWeenie(BuildHardcoreCrawlerGuideBook());
...
Old Marra writes that a Nomad who says 'Zuthra vek' has either noticed something important or wants everyone to believe they have. Both uses are traditional.");
        ...
        private static Weenie BuildHardcoreCrawlerGuideBook()
        {
            var w = new Weenie
            {
                WeenieClassId = HardcoreCrawlerGuideBookWeenieClassId,
                ClassName     = "ace2000621-hardcorecrawlerguide",
                WeenieType    = WeenieType.Book,
            ...
            w.PropertiesString[PropertyString.ShortDesc]   = "A field guide for Hardcore Crawler characters.";
            w.PropertiesString[PropertyString.LongDesc]    = "A sharp little guide for Hardcore crawlers who choose boons, live by momentum, and keep finding stranger tools than they deserve.";
            ...
            AddBookPage(w, "I. The First Bad Idea\n\nHardcore Crawler is still Hardcore. You have lives, and losing all of them still means the road writes your ending in permanent ink. The difference is that this path rewards movement, use, and adaptation.\n\nYou begin with nothing trained. Use a skill enough and it becomes trained if you have the credits. Keep using it and it can specialize, still respecting the normal specialized credit limit. Specialized rank growth is what pushes your Crawler level forward.\n\nThis mode is not meant to be fair in the tidy way. It is meant to be tempting, dangerous, and full of decisions you can blame on yourself later.");
