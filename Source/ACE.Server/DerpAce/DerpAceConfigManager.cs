...
namespace ACE.Server.DerpAce
{
    ...
    public static class DerpAceConfigManager
    {
        ...
        private static void Apply()
        {
            ...
            DerpACEConfig.RallyBannerEnabled = c.RallyBannerEnabled;
            DerpACEConfig.RallyBannerItemWcid = c.RallyBannerItemWcid;
            DerpACEConfig.RallyBannerVisualWcid = c.RallyBannerVisualWcid;
            DerpACEConfig.RallyBannerDurationSeconds = c.RallyBannerDurationSeconds;
            DerpACEConfig.RallyBannerPulseSeconds = c.RallyBannerPulseSeconds;
            DerpACEConfig.RallyBannerAuraSeconds = c.RallyBannerAuraSeconds;
            DerpACEConfig.RallyBannerCooldownSeconds = c.RallyBannerCooldownSeconds;
