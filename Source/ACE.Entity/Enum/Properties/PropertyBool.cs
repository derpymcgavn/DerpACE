...
namespace ACE.Entity.Enum.Properties
{
    ...
    public enum PropertyBool : ushort
    {
        ...
        /* DerpACE Ironman Nomad submode — no weapons/casters, unarmed via gauntlets/shoes, natural AL 420 while unarmored */
        IsIronmanNomad                   = 9039,
        ...
        IsHandCrossbow                   = 9074,
        IsPugilistUnarmedWeapon          = 9075,
        IsSlayerGem                      = 9076,
        IsChargedSlayerGem               = 9077,
        IsBattlemageHelm                 = 9078,
        IsSpellFocus                     = 9079,
        CorpseHexdustHarvested           = 9080,
        ...
        IsShadowVolleyWeapon             = 9085,
        IsSecondShadowWeapon             = 9086,
